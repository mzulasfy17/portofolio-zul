      ...
      items: [
        {
          ...
          description: [
            "Mempelajari algoritma, struktur data, basis data, rekayasa perangkat lunak, jaringan komputer, dan kecerdasan buatan.",
            "Aktif dalam berbagai praktikum dan proyek pengembangan aplikasi.",
          ],
          year: "2022 – 2026",
    ...
    projectsPage: {
      ...
      projectsList: {
        ...
        portofolio: {
          ...
          description: "Website portofolio pribadi berbasis React.js untuk menampilkan profil, keterampilan, pengalaman, dan proyek secara profesional.",
          longDescription: "Website portofolio pribadi yang dirancang untuk menampilkan profil, pendidikan, pengalaman, keterampilan, serta berbagai proyek yang telah dikerjakan. Website ini dikembangkan dengan desain modern, responsif, dan interaktif untuk memberikan pengalaman pengguna yang nyaman sekaligus menjadi media profesional dalam memperkenalkan kemampuan di bidang Front-End Development dan Mobile Development.",
        },
        linguatalespaper: {
          title: "Implementasi Speech Synthesis Berbasis Mobile untuk Pelestarian Cerita Rakyat dalam Dialek Melayu Kepulauan Meranti",
          category: "RISET",
          description: "Penelitian tentang implementasi speech synthesis untuk mendukung pelestarian cerita rakyat dalam dialek Melayu Kepulauan Meranti.",
          longDescription: "Penelitian yang membahas implementasi teknologi speech synthesis berbasis mobile sebagai upaya pelestarian cerita rakyat dalam dialek Melayu Kepulauan Meranti. Penelitian ini berfokus pada pemanfaatan teknologi sintesis suara untuk membantu mempertahankan dan memperkenalkan cerita rakyat serta karakteristik dialek Melayu Kepulauan Meranti melalui media digital.",
        },
      },
    },
      ...
      items: [
        {
          ...
          date: "Jul 2022 – Jul 2026",
          description: [
            "Studied algorithms, data structures, databases, software engineering, computer networks, and artificial intelligence.", 
            "Active in practical labs and application development projects.",
          ],
          year: "2022 – 2026",
          place: "UIN Sultan Syarif Kasim Riau",
          location: "Pekanbaru, Indonesia",
    ...
    projectsPage: {
      ...
      projectsList: {
        ...
        portofolio: {
          ...
          category: "WEB DEVELOPMENT",
          description: "Personal portfolio website built with React.js to showcase profile, skills, experience, and projects professionally.",
          longDescription: "Personal portfolio website designed to showcase profile, education, experience, skills, and various projects worked on. Developed with a modern, responsive, and interactive design to provide a pleasant user experience while serving as a professional medium to introduce capabilities in Front-End Development and Mobile Development.",
        },
        linguatalespaper: {
          title: "Implementation of Mobile-Based Speech Synthesis for Folklore Preservation in Meranti Islands Malay Dialect",
          category: "RESEARCH",
          description: "Research on the implementation of speech synthesis to support the preservation of folklore in the Meranti Islands Malay dialect.",
          longDescription: "Research discussing the implementation of mobile-based speech synthesis technology as an effort to preserve folklore in the Meranti Islands Malay dialect. This study focuses on utilizing voice synthesis technology to help maintain and introduce folklore and dialect characteristics of Meranti Islands Malay through digital media.",
        },
      },
    },
